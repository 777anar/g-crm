...
from modules.sales.presentation.api.project_item_drawings import router as project_item_drawings_router
from modules.sales.presentation.api.project_item_measurements import router as project_item_measurements_router
from modules.sales.presentation.api.project_item_photos import router as project_item_photos_router
from modules.sales.presentation.api.project_items import router as project_items_router
...
from modules.sales.presentation.api.rooms import router as rooms_router
...
sales_router.include_router(rooms_router)
sales_router.include_router(project_items_router)
sales_router.include_router(project_item_measurements_router)
sales_router.include_router(project_item_drawings_router)
sales_router.include_router(project_item_photos_router)
