...
Production, Installation, and Finance (as real modules, not Orders-embedded fields) are the next unbuilt items per the dependency chain, followed by Tasks & Reminders (1.2) which has now been skipped twice in favor of the Version 2.0 chain.
