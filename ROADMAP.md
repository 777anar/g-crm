...
Tasks & Reminders (1.2) remains the next unbuilt item below Version 2.0's Stone Catalog; the rest of the roadmap (Sales onward) awaits its turn per the dependency chain above.
